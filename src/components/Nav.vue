  ...
  <div id="nav">
    <el-container>
      <el-aside width="200px">
        <Menu :name="nickName" :menuId="modIdd" @modIdd="listenToMenu"></Menu>
      </el-aside>
      <el-container>
        <el-header>
        ...
        <el-main>
          <GoalManage :name="nickName" @count="listenToChild" v-if="modIdd === '001'"></GoalManage>
          <StageManage :name="nickName" @count="listenToChild" v-if="modIdd === '002'"></StageManage>
          <WishManage :name="nickName" @count="listenToChild" v-if="modIdd === '004'"></WishManage>
          <WisdomManage :name="nickName" @count="listenToChild" v-if="modIdd === '005'"></WisdomManage>
        </el-main>
